...
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=.1]{"../../../outputs/h0Kva_20230118_SSA/plots/MichaelisMenten_mean_evol_SSACME.pdf"}
\caption{default}
\label{default}
\end{center}
\end{figure}
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=.1]{"../../../outputs/h0Kva_20230118_SSA/plots/MichaelisMenten_mean_evol_SSACMEDet.pdf"}
\caption{default}
\label{default}
\end{center}
\end{figure}
